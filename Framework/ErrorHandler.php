...
class ErrorHandler{
  ...
  public static function Go($ErrorCode)
  {
    header("HTTP/1.0 $ErrorCode ".self::$http_status_codes[$ErrorCode]);
    Page::$Title = self::$http_status_codes[$ErrorCode];
    Page::View("$ErrorCode@ErrorPage", "ErrorPages", "Default");
    die;
  }
}
?>
